...
function  stringReplce(){
    var str = "karachi";
    var res = str.replace("karachi", "Islam");
    document.write("<h1> City: " + str +"<br> After replacement: " + res);
}
/////----Task No.8
function  stringReplceAll(){
    var str = "alina and sara are best friends. They play cricket and football together.";
...
function elapsedMinutes(){
    var firstDate = new Date("mar 3 ,2001");
    var today= new Date();
